...
cl = LINETCR.LINE()
cl.login(token="Eo4edpozNn4n7LH3vU66.G/Wfy1Uc1TzGLglt6XMIvG.XUklFJlceF6qOdauNAxVQ+soST5PB7DWvuPJj1XAmKE=")
cl.loginResult()

kt = LINETCR.LINE()
kt.login(token="EoTYqbnsAgQUHdPUf1j3.PO2mxua7yezSl0OyrvexqW.pJZzv4tdOFvT/6tVH3QpIMGwTdqBOHhr3OhdvfOZBbA=")
kt.loginResult()

ks = LINETCR.LINE()
ks.login(token="Eo9zyTtfNLtXcGNUeJ19.DWoyAOBOui7YzeZEhwxVgq.OGc+DBfRczXYWv+NmcqGWabKOzEM/asgUevcxl36ZYA=")
ks.loginResult()

ki = LINETCR.LINE()
ki.login(token="EoPQaB8MjSKEoCu7UbF6.KXGa04BfPNKssx+hmzsAfG.HMRSR+2fMCUJ71YFebCHEIeTdFRc5Chp3heRbuwV3qQ=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="Eovw5bQQoi6sWPg2VT76.YIoTN95Q1qaMuENyZwW+vG.OYlG9ucpDyNuOiLwE5Ymnh8WvkjLF1/yh60to1/u7cY=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="EoosQ5mz0cY0uVaSdcse.BaGGceyktzJyyicyNuINhG.+oByyPDjPseKkNNWsqqpr1AYmfU5B0RMYijVwFnd/8g=")
kc.loginResult()

kl = LINETCR.LINE()
kl.login(token="Eog5BrU7yITansoj3uGe.CKbThNm0bBMP1wJdm36K3G.ePcuLTnEwKNvlZiP4jNjHHWBr/M3fFUEYMl3gUWKG4k=")
kl.loginResult()
...
autoleaveroom = []
targets = []
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid, "uad34741ca0bacd2e2cdee087e9729ea1"]
admin = ["uad34741ca0bacd2e2cdee087e9729ea1"]
owner = ["uad34741ca0bacd2e2cdee087e9729ea1"]
creator=["uad34741ca0bacd2e2cdee087e9729ea1"]
wait = {
    'contact':False,
    'autoJoin':True,
...
#Tolong Jangan Ganti mid CreatorNya Hargai Saya yang membuat!!!#
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': 'uad34741ca0bacd2e2cdee087e9729ea1'}
                cl.sendMessage(msg)
                cl.sendText(msg.to,"ʙᴀɴᴅ͡ᴶᴼᴼᴸ™")
...
#==========================================================
			...
			ks.sendText(msg.to,Amid)
			ks.sendText(msg.to,Bmid)
